...
<!--#elif /* Development mode. */-->
    <link rel="resource" type="application/l10n" href="{{asset('pdf.js/web/locale/locale.json')}}">
    ...
    <!-- <script type="importmap">
        {
            ...
            "fluent-bundle": "../pdf.js/node_modules/@fluent/bundle/esm/index.js",
            "fluent-dom": "../pdf.js/node_modules/@fluent/dom/esm/index.js",
            "cached-iterable": "../pdf.js/node_modules/cached-iterable/src/index.mjs",

            "display-cmap_reader_factory": "../pdf.js/src/display/cmap_reader_factory.js",
            "display-standard_fontdata_factory": "../pdf.js/src/display/standard_fontdata_factory.js",
            "display-wasm_factory": "../pdf.js/src/display/wasm_factory.js",
            "display-fetch_stream": "../pdf.js/src/display/fetch_stream.js",
            "display-network": "../pdf.js/src/display/network.js",
            "display-node_stream": "../pdf.js/src/display/stubs.js",
            "display-node_utils": "../pdf.js/src/display/stubs.js",

            "web-alt_text_manager": "../pdf.js/web/alt_text_manager.js",
            "web-annotation_editor_params": "../pdf.js/web/annotation_editor_params.js",
            "web-download_manager": "../pdf.js/web/download_manager.js",
            "web-external_services": "../pdf.js/web/genericcom.js",
            "web-new_alt_text_manager": "../pdf.js/web/new_alt_text_manager.js",
            "web-null_l10n": "../pdf.js/web/genericl10n.js",
            "web-pdf_attachment_viewer": "../pdf.js/web/pdf_attachment_viewer.js",
            "web-pdf_cursor_tools": "../pdf.js/web/pdf_cursor_tools.js",
            "web-pdf_document_properties": "../pdf.js/web/pdf_document_properties.js",
            "web-pdf_find_bar": "../pdf.js/web/pdf_find_bar.js",
            "web-pdf_layer_viewer": "../pdf.js/web/pdf_layer_viewer.js",
            "web-pdf_outline_viewer": "../pdf.js/web/pdf_outline_viewer.js",
            "web-pdf_presentation_mode": "../pdf.js/web/pdf_presentation_mode.js",
            "web-pdf_sidebar": "../pdf.js/web/pdf_sidebar.js",
            "web-pdf_thumbnail_viewer": "../pdf.js/web/pdf_thumbnail_viewer.js",
            "web-preferences": "../pdf.js/web/genericcom.js",
            "web-print_service": "../pdf.js/web/pdf_print_service.js",
            "web-secondary_toolbar": "../pdf.js/web/secondary_toolbar.js",
            "web-signature_manager": "../pdf.js/web/signature_manager.js",
            "web-toolbar": "../pdf.js/web/toolbar.js"
            }
        }
        </script> -->
    <script>
      window.LaravelEchoConfig = {
        presenceChannel: 'book.' + @json($bookId),
        whisperChannel: 'book.down.' + @json($bookId),
        bookId: @json($bookId),
      };
      @isset($diffs)
        window.autosavedDiffs = @json($diffs);
      @else
        window.autosavedDiffs = {};
      @endisset
      @isset($links)
      ...
      @else
        window.links = {};
      @endisset
      window.bookUrl = @json($bookUrl);
      window.bookTitle = @json($bookTitle);
      if (window.links) {
            ...
            <div id="toolbarViewer" class="toolbarHorizontalGroup">
              ...
              <div id="toolbarViewerRight" class="toolbarHorizontalGroup">
                <div id="editorModeButtons" class="toolbarHorizontalGroup" role="radiogroup">
                  ...
                  <div id="editorErase" class="toolbarButtonWithContainer">
                    <button id="editorEraseButton" class="toolbarButton" type="button" title="Erase ink" role="radio" aria-haspopup="false" tabindex="0" data-l10n-id="pdfjs-editor-erase-button">
                      <span data-l10n-id="pdfjs-editor-erase-button-label">Erase ink</span>
                    </button>
                  </div>
